...
extension L10n {
    static let zh: [String: String] = [
        ...
        "settings.shortcut.quickPasteReservedCommand": "该按键已用于快速粘贴浮窗的导航或搜索",
    ...
    static let en: [String: String] = [
        ...
        "settings.shortcut.quickPasteReservedCommand": "This key is reserved for Quick Paste navigation or search",
