...
extension L10n {
    static let zh: [String: String] = [
        ...
        "settings.privacy.categories.title": "识别分类",
        "settings.privacy.category.phone": "手机号",
        "settings.privacy.category.phone.subtitle": "识别中国大陆手机号,展示为 138****5678。",
        "settings.privacy.category.key": "密钥 / 令牌 / 密码",
        "settings.privacy.category.key.subtitle": "识别 appkey、api_key、token、secret、password 等标签形态,以及 sk-、ghp_、AKIA 等高置信前缀。",
        "settings.privacy.category.custom": "自定义规则",
        "settings.privacy.category.custom.subtitle": "按下方自定义的关键词或正则表达式识别,命中内容与内置分类一样做脱敏展示。",
        "settings.privacy.customRules.title": "自定义规则",
        "settings.privacy.customRules.subtitle": "添加关键词或正则表达式来自定义判断方式;命中的内容会被脱敏展示,原始内容不受影响。",
    ...
    static let en: [String: String] = [
        ...
        "settings.privacy.categories.title": "Detectors",
        "settings.privacy.category.phone": "Phone numbers",
        "settings.privacy.category.phone.subtitle": "Detect Chinese mainland mobile numbers, shown as 138****5678.",
        "settings.privacy.category.key": "Keys / tokens / passwords",
        "settings.privacy.category.key.subtitle": "Detect labeled values like appkey, api_key, token, secret, password, plus high-confidence prefixes such as sk-, ghp_, AKIA.",
        "settings.privacy.category.custom": "Custom rules",
        "settings.privacy.category.custom.subtitle": "Detect with your own keywords or regular expressions below; matches are redacted just like the built-in detectors.",
        "settings.privacy.customRules.title": "Custom Rules",
        "settings.privacy.customRules.subtitle": "Add keywords or regular expressions to define your own detectors; matches are shown redacted while the original stays intact.",
