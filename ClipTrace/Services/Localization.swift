...
extension L10n {
    static let zh: [String: String] = [
        ...
        "settings.sync.icloud.subtitle": "同步文件保存在你的 iCloud Drive / ClipTrace 中，无需额外账户",
        "settings.sync.icloud.unavailable": "未检测到 iCloud 云盘，请先在系统设置中开启 iCloud Drive",
        "settings.sync.webdav.title": "WebDAV 服务器",
        "settings.sync.webdav.subtitle": "填写一个已存在且可写的目录地址；剪迹会在其中创建 .cliptrace-sync-v1",
    ...
    static let en: [String: String] = [
        ...
        "settings.sync.icloud.subtitle": "Stores encrypted sync files in iCloud Drive / ClipTrace without another account",
        ...
        "settings.sync.webdav.subtitle": "Enter an existing writable directory. ClipTrace creates .cliptrace-sync-v1 inside it.",
        "settings.sync.webdav.url": "https://dav.example.com/remote.php/dav/files/name/",
        ...
        "settings.sync.error.newerFormat": "This sync data was created by a newer ClipTrace version. Update the app first.",
        ...
        "settings.sync.error.invalidEncryptedFile": "The remote file is not valid encrypted ClipTrace data",
        ...
        "axOnboarding.subtitle": "Let ClipTrace press ⌘V for you",
        "axOnboarding.body": "After you pick an item in the Quick Paste panel, ClipTrace needs the Accessibility permission to send ⌘V to the target app. Without it, items are only copied to the clipboard and you have to paste by hand.",
        "axOnboarding.step1": "Click \"Open System Settings\" below",
        "axOnboarding.step2": "Find ClipTrace under Privacy & Security → Accessibility",
