...
本仓库是 Clipth 的开源基础功能版本，包含本仓库许可证所覆盖的剪贴板、搜索、整理、隐私、同步和 MCP 等核心功能。

Clipth Pro 是独立的商业版本。Pro 专属功能、商业服务、支付与授权逻辑以及其他专有实现，均不属于本仓库，也不会随开源版本发布。请不要假定 Pro 版本中的代码或功能在本仓库中可用。
