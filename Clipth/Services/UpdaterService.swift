...
final class UpdaterService: ObservableObject {
    ...
    private let userDriver: ClipthUpdaterUserDriver
    private let delegate = ClipthUpdaterDelegate()
    ...
    private init() {
        userDriver = ClipthUpdaterUserDriver(
            hostBundle: .main,
            delegate: delegate
        )
        updater = SPUUpdater(
...
private final class ClipthUpdaterDelegate: NSObject, SPUUpdaterDelegate, SPUStandardUserDriverDelegate {
...
@MainActor
private final class ClipthUpdaterUserDriver: SPUStandardUserDriver {
